...
class StatusIndicator(Widget):
    """A small circular indicator that shows green when server_running is True and red otherwise."""
    server_running = BooleanProperty(False)

# Dashboard and indicator code
class EnhancedDashboard(BoxLayout):
    ...
    def start_stop_server(self):
        ...
        if not self.server_running:
            ...
            self.append_log("Custom HTTP server started.")
        else:
            if self.httpd:
                self.httpd.shutdown()
                self.httpd.server_close()
                self.httpd = None
                self.append_log("Custom HTTP server shutdown.")
...
# KV string with professional colors and a header traffic indicator.
kv = '''
...
<EnhancedDashboard>:
    canvas.before:
        ...
        RoundedRectangle:
            ...
            size: self.size
            radius: [dp(20),]
    # Header: Contains title and a traffic-signal indicator.
    BoxLayout:
        size_hint_y: 0.12
        padding: dp(10)
        spacing: dp(10)
        canvas.before:
            ...
            RoundedRectangle:
                ...
                radius: [dp(20),]
        Label:
            text: "IT Tools Server Dashboard"
            ...
            BoxLayout:
                ...
                BoxLayout:
                    ...
                    Label:
                        ...
                        valign: "middle"
                        text_size: self.size
                # Action Buttons Card: Fixed height container.
                BoxLayout:
                    size_hint_y: None
                    height: dp(60)
                    spacing: dp(15)
